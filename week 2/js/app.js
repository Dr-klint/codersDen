...
const challengeSubstr = challenge.substr(0, 2);
const challengeSubstring = challenge.substring(0, 2);
console.log(challengeSubstr, challengeSubstring);

//   Slice out the phrase Days Of JavaScript from 30 Days Of JavaScript.
const challengeSlice = challenge.slice(3);
...
console.log(
  "He earns 5000 euro from salary per month, 10000 euro annual bonus, 15000 euro online courses per month.".match(
    /\d+/g
  )
);
